...
const translations = {
  en: {
    ...
    'mood.amazingDesc': 'Feeling absolutely fantastic!',
    'mood.great': 'Great',
    'mood.greatDesc': 'Feeling wonderful and energetic!',
    'mood.good': 'Good',
    'mood.goodDesc': 'Generally positive and content',
    'mood.neutral': 'Neutral',
    'mood.neutralDesc': 'Feeling balanced, neither good nor bad',
    'mood.okay': 'Okay',
  ...
  es: {
    ...
    'pricing.premium': 'Premium',
    'pricing.freePrice': '$0/month',
    'pricing.basicPrice': '$7.99/month',
    'pricing.plusPrice': '$12.99/month',
    'pricing.proPrice': '$19.99/month',
    'pricing.premiumPrice': '$9.99/month',
    'pricing.getStarted': 'Get Started',
    'pricing.upgrade': 'Upgrade Now',
    'pricing.currentPlan': 'Current Plan',
    ...
    'roleplay.family': 'Family',
    'roleplay.romantic': 'Romantic',
    'roleplay.howItWorks': 'How it works',
    'roleplay.instructions.ai': '• AI takes on different roles based on your choice',
    'roleplay.instructions.practice': '• Practice real conversations in a safe environment',
    'roleplay.instructions.experiment': '• Try different approaches and responses',
    'roleplay.instructions.safe': '• Everything is confidential and judgment-free',
    'roleplay.instructions.stop': '• Stop anytime by clicking "End Roleplay"',
    'roleplay.started': 'Roleplay Started',
    'roleplay.startedDesc': 'You can now practice your conversation skills',
    'roleplay.active': 'Active',
    'roleplay.end': 'End Roleplay',
    'roleplay.placeholder': 'Type your message...',
    'roleplay.send': 'Send',
    'roleplay.reminder': 'Remember: This is practice. Feel free to experiment!',
    'roleplay.partner.title': 'Talk to Partner',
    'roleplay.partner.description': 'Practice conversations with your romantic partner',
    'roleplay.partner.role': 'I am your understanding and caring partner',
    'roleplay.parent.title': 'Talk to Parent',
    'roleplay.parent.description': 'Practice family conversations and boundary setting',
    'roleplay.parent.role': 'I am a caring but sometimes challenging parent',
    'roleplay.boss.title': 'Talk to Boss',
    'roleplay.boss.description': 'Practice workplace discussions and negotiations',
    'roleplay.boss.role': 'I am your professional but demanding boss',
    'roleplay.friend.title': 'Talk to Friend',
    'roleplay.friend.description': 'Practice friendship conversations and conflicts',
    'roleplay.friend.role': 'I am your close and supportive friend'
  },
