-- AI Lifestyle Plans
CREATE TABLE IF NOT EXISTS public.ai_lifestyle_plans (
...
-- Safety Network
CREATE TABLE IF NOT EXISTS public.safety_networks (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
-- AI Role Modes
CREATE TABLE IF NOT EXISTS public.ai_role_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.vr_ar_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.financial_wellness (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.relationship_coaching (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.crisis_ai_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.group_therapy_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.group_therapy_participants (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_ai_lifestyle_plans_user_id ON public.ai_lifestyle_plans(user_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_role_sessions_user_id ON public.ai_role_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_vr_ar_sessions_user_id ON public.vr_ar_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_financial_wellness_user_id ON public.financial_wellness(user_id);
CREATE INDEX IF NOT EXISTS idx_relationship_coaching_user_id ON public.relationship_coaching(user_id);
CREATE INDEX IF NOT EXISTS idx_crisis_ai_sessions_user_id ON public.crisis_ai_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_group_therapy_participants_user_id ON public.group_therapy_participants(user_id);
CREATE INDEX IF NOT EXISTS idx_group_therapy_participants_session_id ON public.group_therapy_participants(session_id);