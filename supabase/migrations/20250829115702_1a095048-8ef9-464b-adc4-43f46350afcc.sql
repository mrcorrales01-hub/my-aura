-- CRITICAL SECURITY FIXES MIGRATION (Fixed Order)
...
CREATE POLICY "System only security metrics modifications"
ON public.security_metrics
FOR INSERT, UPDATE, DELETE  
USING (false)
WITH CHECK (false);
...
-- =====================================================================
-- PHASE 7: REVOKE DANGEROUS PERMISSIONS & GRANT ESSENTIAL ONES
-- =====================================================================
...
-- Grant select permission on the secure marketplace function
GRANT EXECUTE ON FUNCTION public.get_secure_therapist_marketplace() TO authenticated;
...
SELECT public.log_security_event_enhanced(
  ...
  NULL,
  jsonb_build_object(
    'migration', 'comprehensive_security_fixes_v2',
    'timestamp', now(),
